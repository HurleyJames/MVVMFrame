...
import ac.hurley.library_base.action.WeakAction;

/**
 * <pre>
 *      @author hurley
 *      date    : 4/16/21 2:01 PM
...
public class Messenger {
     ...
     */
    public <T> void register(Object recipient, Class<T> tClass, BindingConsumerAction<T> action) {
     ...
     * @param <T>                       message data type
     */
    public <T> void register(Object recipient, boolean receiveDerivedMessagesToo, Class<T> tClass, BindingConsumerAction<T> action) {
     ...
     *                  will
     *                  receive this msg
     * @param tClass    class of T for BindingConsumerAction
     * @param action    this action has one params that type of tClass
     * @param <T>       message data type
     */
    public <T> void register(Object recipient, Object token, Class<T> tClass, BindingConsumerAction<T> action) {
     ...
     * @param <T>                       message data type
     */
    public <T> void register(Object recipient, Object token, boolean receiveDerivedMessagesToo, BindingConsumerAction<T> action, Class<T> tClass) {
    ...
    private static <T> void unregisterFromLists(
            Object recipient,
            BindingConsumerAction<T> action,
        ...
        synchronized (lists) {
            for (WeakActionAndToken item : lists.get(messageType)) {
                ...
                if (weakActionCasted != null
                        ...
                        && (action == null
                        || action == weakActionCasted.getBindingConsumerAction())) {
